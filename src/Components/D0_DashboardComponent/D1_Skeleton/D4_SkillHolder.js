const D4_SkillHolder = ({image,title, value}) =>{
    return(
        <>
            <div className={`bg-gray-800 w-24 h-32 rounded-md hover:cursor-pointer shadow-md hover:shadow-2xl hover:shadow-cyan-400 shadow-cyan-400 flex flex-col justify-center items-center sm:w-48 sm:h-64 hover:bg-gray-600`}>
