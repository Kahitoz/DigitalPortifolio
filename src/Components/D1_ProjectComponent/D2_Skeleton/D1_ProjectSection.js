                        ...
                        <div className={`bg-gray-800 rounded-xl p-4 hover:cursor-pointer hover:shadow-2xl hover:shadow-cyan-400 hover:rounded-2xl hover:bg-gray-600 shadow-md shadow-cyan-400`}>
                            <div className={`flex justify-between`}>
                                ...
                                <img src={project.img0}
                                     className={`w-16 h-16 rounded-full`} alt={project.title}/>
                            </div>
                            <div>
                                <p className={`text-xl font-bold text-white text-center`}>{project.short_desc}</p>
                                <p className={`text-md font-bold text-white text-center mt-4`}>Skills: {project.skills}</p>
                            </div>
                            <div className={`mt-5 flex justify-between`}>
                                <p className={`text-sm font-bold text-white text-center`}>From {project.start}</p>
                                <p className={`text-sm font-bold text-white text-center`}>Status: {project.status}</p>
                                <p className={`text-sm font-bold text-white text-center`}>To:{project.end}</p>
                            </div>
                        </div>
                    </div>
